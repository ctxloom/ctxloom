...
and it carries no assertions of its own — j2_team_authoring.feature next to it
is the single source of truth for what J2 promises. What lives here is the
...
marker pairs the generator splits j1_setup.doc.md on. A scenario with no
