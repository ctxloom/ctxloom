---
title: "ctxloom trust signer delete"
---
...
:::note
This page is generated from `ctxloom trust signer delete --help`.
:::

## ctxloom trust signer delete
...
```
ctxloom trust signer delete <principal> [flags]
```
