<!--
J6 narration companion.

Prose ONLY. It never restates what the Gherkin already says business-readably,
and it carries no assertions of its own — j6_delegation.feature next to it is
the single source of truth for what J6 promises. What lives here is the
...
marker pairs j1_setup.doc.md / j5_multi_engine.doc.md split on.
-->
