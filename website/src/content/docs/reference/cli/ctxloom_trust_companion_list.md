---
title: "ctxloom trust companion list"
---
...
:::note
This page is generated from `ctxloom trust companion list --help`.
:::

## ctxloom trust companion list

List recorded companion execution decisions
...
```
ctxloom trust companion list [flags]
```
