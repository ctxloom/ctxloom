<!--
J18 narration companion.

Prose ONLY. It never restates what the Gherkin already says business-readably,
and it carries no assertions of its own — j18_guardrails.feature next to it is
the single source of truth for what J18 promises.
