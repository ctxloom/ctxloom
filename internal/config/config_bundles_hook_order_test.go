...
func TestExtractHooksFromBundle_OrderFieldSequencesWithinAnEvent(t *testing.T) {
	...
	got := extractHooksFromBundle(&bundles.Bundle{Hooks: bundles.BundleHooks{PreTool: in}}, "src", nil)
...
func TestExtractHooksFromBundle_GateRefsStayAuthoredIndex(t *testing.T) {
	...
	got := extractHooksFromBundle(
		&bundles.Bundle{Hooks: bundles.BundleHooks{PreTool: in}}, "remote/tools", recordingGate(seen))
...
func TestExtractHooksFromBundle_DenialDoesNotDisturbRemainingOrder(t *testing.T) {
	...
	got := extractHooksFromBundle(
		&bundles.Bundle{Hooks: bundles.BundleHooks{PreTool: in}}, "remote/tools",
		recordingGate(nil, "#hooks/pre_tool/1"))
