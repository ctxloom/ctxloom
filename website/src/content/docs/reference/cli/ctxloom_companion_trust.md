...
:::note
This page is generated from `ctxloom companion trust --help`.
:::

## ctxloom companion trust
...
```
ctxloom companion trust <path-or-name> [flags]
```
