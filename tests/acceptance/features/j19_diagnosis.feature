...
Feature: The day the assistant goes blind
  ...
  # NOTE ON SCOPE. J16 owns the PRODUCTION of signatures; J15 and J17 own the
  ...
  # now refuses and names the missing grant, proved by j16_signing.feature's
  ...
  # J4's live table proves ingestion in CI; it is not a tool a user can run.
