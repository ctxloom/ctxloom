...
You are an agent about to act. Below is an INDEX of context fragments you may load.
You see each fragment's NAME and its PREMISE -- the condition under which it applies.
The bodies are withheld.
