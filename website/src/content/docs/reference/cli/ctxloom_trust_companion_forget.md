---
title: "ctxloom trust companion forget"
---
...
:::note
This page is generated from `ctxloom trust companion forget --help`.
:::

## ctxloom trust companion forget

Drop the recorded decision for a companion binary (it is asked about again)
...
```
ctxloom trust companion forget <path-or-name> [flags]
```
