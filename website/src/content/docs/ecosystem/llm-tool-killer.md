...
[**llm-tool-killer**](https://github.com/ctxloom/llm-tool-killer) (`ltk`) is a sibling project in the ctxloom org. Where ctxloom shapes the **context** an AI coding agent sees, `ltk` guides the **commands** it runs.
...
```sh
go install github.com/ctxloom/llm-tool-killer/cmd/ltk@latest
# or build a static binary from source: just build-static
```
