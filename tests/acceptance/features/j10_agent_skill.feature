...
Feature: The ctxloom-doctor Agent Skill reaches every engine's native skill surface
  ...
  # PATH CORRECTION vs the command surface (j5_multi_engine.feature's own
  ...
  # source (see steps_j10_doctor.go's engineSkillMDPath doc for the full
  # story):
  #
  ...
  # like its Commands surface (j5_multi_engine.feature's own codex row) —
