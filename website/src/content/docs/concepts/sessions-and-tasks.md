...
Tasks are tracked through ctxloom's MCP tools:
...
| | Agent to-dos (TodoWrite) | ctxloom tasks |
|---|---|---|
...
right now*; use ctxloom tasks for *work that should still exist tomorrow*.
