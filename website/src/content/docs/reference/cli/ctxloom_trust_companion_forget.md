---
title: "ctxloom companion untrust"
---
...
:::note
This page is generated from `ctxloom companion untrust --help`.
:::

## ctxloom companion untrust
...
```
ctxloom companion untrust <path-or-name> [flags]
```
