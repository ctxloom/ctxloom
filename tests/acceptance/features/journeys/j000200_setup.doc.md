<!--
J000200 narration companion (PROTOTYPE — see docs/living-docs-plan.md).
...
file next to it is still the single source of truth for what J000200 promises.
...
<!-- doc:outro -->
J000200 stops at the trust boundary: what reaches a real assistant, and why. What
...
(`j000300_source_augmentation.feature`; not yet published as its own page).
