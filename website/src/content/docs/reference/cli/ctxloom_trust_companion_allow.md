---
title: "ctxloom trust companion allow"
---
...
:::note
This page is generated from `ctxloom trust companion allow --help`.
:::

## ctxloom trust companion allow

Record that ctxloom may execute a companion binary
...
```
ctxloom trust companion allow <path-or-name> [flags]
```
