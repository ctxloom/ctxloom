...
// (internal/transcript/importer/codex/) so the schema-conformance test can
...
// importer.VendorAdapter's doc comment promises, and the one property that
// distinguishes an honest importer from the deleted codex reader (which
