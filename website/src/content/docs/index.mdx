...
1. **Bundles** contain fragments (context), skills (slash commands), and MCP servers
...
| **Skill** | A saved prompt template, exported as a slash command |
| **Bundle** | A versioned YAML containing fragments + skills + MCP servers |
...
<CardGrid>
  ...
  <Card title="Bundles" icon="puzzle">
    [Fragment and skill structure](/concepts/bundles/)
  </Card>
