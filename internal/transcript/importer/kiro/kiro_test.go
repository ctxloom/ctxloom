...
// engine's adapter, no other package under internal/transcript/importer. A
// release-monitoring job validating just kiro against a fresh
// data.sqlite3 runs it alone with:
//
//	go test ./internal/transcript/importer/kiro/...
//
// or, from the module root, restricted to this package's own tests:
//
//	go test -run . ./internal/transcript/importer/kiro
//
...
// (internal/transcript/importer/kiro/) so the schema-conformance test can
...
// importer.VendorAdapter's doc comment carves out.
