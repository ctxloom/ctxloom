...
// stubExecutable / stubStat install temporary overrides for the
// resolveSelfExecutable seams and restore them on test cleanup.
...
func TestResolveSelfExecutable_HappyPath(t *testing.T) {
	stubExecutable(t, "/usr/local/bin/ctxloom", nil)
	stubStat(t, func(string) (os.FileInfo, error) { return nil, nil })

	assert.Equal(t, "/usr/local/bin/ctxloom", resolveSelfExecutable())
}

func TestResolveSelfExecutable_OSExecutableError(t *testing.T) {
	...
	assert.Equal(t, "ctxloom", resolveSelfExecutable())
}

func TestResolveSelfExecutable_DeletedSuffixStripped(t *testing.T) {
...
func TestResolveSelfExecutable_DeletedAndMissingFallsBack(t *testing.T) {
...
func TestResolveSelfExecutable_PathMissingFallsBack(t *testing.T) {
