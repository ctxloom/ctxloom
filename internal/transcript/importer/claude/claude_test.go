...
//
//	go test ./internal/transcript/importer/claude/...
//
// or, from the module root, restricted to this package's own tests:
//
//	go test -run . ./internal/transcript/importer/claude
package claude
...
// (internal/transcript/importer/claude/) so the schema-conformance test can
...
// importer.VendorAdapter's doc comment promises.
