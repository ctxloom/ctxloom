...
// and nothing else.
//
// R6 (ruled 2026-08-14, ~/.ctxloom/sessions/ugly-icy-squid/config-patching-
// review.md) is this gate's other half: a file ctxloom exclusively owns
...
//
// Generated 2026-08-14, base 9c9bf863 (R6 units 1-4 landed): 9 violations
...
// (config-patching-review.md bypass B1's second half) this gate correctly
// surfaces and this batch does not fix.
