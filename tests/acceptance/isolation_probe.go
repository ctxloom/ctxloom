...
//
// WHAT THIS IS, AND WHY IT IS NOT A j9 SCENARIO. j9_isolation.feature's own
// matrix (steps_j9_isolation_matrix.go) proves ctxloom's SIDE of isolation —
...
// scenario welded into j9's own feature file could not serve that; see
...
//     steps_j9_isolation_matrix.go's package doc states for its own spy.
...
// longer a leak case at all (both HomeVars relocate, per j9's own hermetic
// proof).
