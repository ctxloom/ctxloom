<!--
J15 narration companion (PROTOTYPE — see docs/living-docs-plan.md).

Prose ONLY. It never restates what the Gherkin already says business-readably,
and it carries no assertions of its own — j15_corporate_signed.feature next to it
is the single source of truth for what J15 promises. What lives here is the
...
pairs the generator splits j2_setup.doc.md on. A scenario with no matching block
...
Note what this is **not**. J15 proves *provenance and integrity*, not *secrecy*.
...
trust. Contrast this with [J7](/journeys/j7-team-authoring/), where content is
...
Crucially, this is not J2's benign "held for your review." A missing signature is
...
<!-- doc:outro -->
Taken together, J15 is the enforcement half of the trust model: not "we have a
...
[J7](/journeys/j7-team-authoring/) and the add-and-review flow of
[J2](/journeys/j2-setup/), and it is the concrete exercise of the model laid out
