...
// alone with:
//
//	go test ./internal/transcript/importer/antigravity/...
//
// or, from the module root, restricted to this package's own tests:
//
//	go test -run . ./internal/transcript/importer/antigravity
package antigravity
...
// (internal/transcript/importer/antigravity/) so the schema-conformance test
...
// contract importer.VendorAdapter's doc comment promises.
...
// importer.VendorAdapter's doc comment carves out as the one thing Convert
