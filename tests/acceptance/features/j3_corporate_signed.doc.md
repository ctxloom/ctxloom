<!--
J3 narration companion (PROTOTYPE — see docs/living-docs-plan.md).

Prose ONLY. It never restates what the Gherkin already says business-readably,
and it carries no assertions of its own — j3_corporate_signed.feature next to it
is the single source of truth for what J3 promises. What lives here is the
...
pairs the generator splits j1_setup.doc.md on. A scenario with no matching block
