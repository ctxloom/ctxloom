---
title: "ctxloom mcp server delete"
---
...
:::note
This page is generated from `ctxloom mcp server delete --help`.
:::

## ctxloom mcp server delete

Delete an MCP server configuration

```
ctxloom mcp server delete <name> [flags]
```
