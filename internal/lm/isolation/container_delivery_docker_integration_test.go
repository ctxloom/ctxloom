...
//
// WHY THIS FILE EXISTS. J20's container delivery rows (tests/acceptance,
...
// scenario in j20_bundle_distribution.feature; this file closes it.
//
...
// turn observes nothing whether delivery worked or not (the same reason J20's
