<!--
J000700 narration companion (PROTOTYPE — see docs/living-docs-plan.md).

Prose ONLY. It never restates what the Gherkin already says business-readably,
and it carries no assertions of its own — j000700_team_authoring.feature next to it
is the single source of truth for what J000700 promises. What lives here is the
...
marker pairs the generator splits j000200_setup.doc.md on. A scenario with no
...
it at launch and need a fresh session (the same two-phase shape J000200's restart
