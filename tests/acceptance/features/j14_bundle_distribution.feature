...
Feature: Publishing a bundle's whole surface, and a consumer receiving it intact
  ...
  # ============================================================================
  # WHY THIS IS A NEW JOURNEY (J14) AND NOT AN EXTENSION OF J7/J15/J16
  #
  # Three existing journeys touch neighbouring ground and none of them is the
  # right home:
  #
  #   J7 (team authoring) is FIRST-PARTY and in-project — Carol commits to the
  ...
  #
  #   J15 (corporate signed) is about PROVENANCE AND INTEGRITY of content that
  ...
  #
  #   J16 (signing) is the AUTHOR-side key journey — ssh-agent, allowed_signers,
  ...
  # NOTE ON STEP WORDING: J15 already owns `Alice trusts the company key`, and
  # that step reads J15's OWN fixture state (j15.signer, set by J15's publish
  ...
  # worktree — which is J22's subject (its mock req.WorkDir record) and the
  ...
  # impossible: the suite launched no container anywhere (j22 proves the
