...
// J22 matrix: the per-engine config-home isolation payload the top of
// j22_isolation.feature's own doc used to flag as "needs a real
...
// j22_isolation.doc.md for the full accounting of what is and is not proven
// where.
//
...
// against features/j22_isolation.feature as it stands today and that is no
...
// ApplyLocalCLIConfig, exactly like j22's own CTXLOOM_MOCK_RECORD_FILE):
...
func registerJ22MatrixSteps(ctx *godog.ScenarioContext) {
