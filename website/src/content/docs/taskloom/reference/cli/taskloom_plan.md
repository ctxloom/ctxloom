...
:::note
This page is generated from `taskloom plan --help`.
:::
...
* [taskloom plan list](/taskloom/reference/cli/taskloom_plan_list/)	 - List session plans
* [taskloom plan show](/taskloom/reference/cli/taskloom_plan_show/)	 - Print a plan's content
