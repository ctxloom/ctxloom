...
const nextStepTestHarp = "dizzy-balmy-opium"
...
func TestCaptureNextStep_WritesTheTurnsFinalMessageUnderTheHarp(t *testing.T) {
	...
	t.Setenv(agent.SessionHarpEnv, nextStepTestHarp)
	...
	got, ok := memory.ReadNextStep(nextStepTestHarp)
...
func TestCaptureNextStep_TakesTheFinalMessageNotTheToolCall(t *testing.T) {
	...
	got, _ := memory.ReadNextStep(nextStepTestHarp)
...
func TestCaptureNextStep_NamesWhyItCapturedNothing(t *testing.T) {
	tests := []struct {
		...
		{"no harp in the environment", "", func(t *testing.T) string { return stopPayload(turnEndingWith(t, "x")) }},
		{"undecodable payload", nextStepTestHarp, func(t *testing.T) string { return "not json at all" }},
		{"payload carries no transcript_path", nextStepTestHarp, func(t *testing.T) string { return `{"session_id":"s"}` }},
		{"transcript cannot be read", nextStepTestHarp, func(t *testing.T) string { return stopPayload("/nonexistent/t.jsonl") }},
		{"turn produced no assistant message", nextStepTestHarp, func(t *testing.T) string {
