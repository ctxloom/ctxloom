---
title: "ctxloom trust publish forget"
---
...
:::note
This page is generated from `ctxloom trust publish forget --help`.
:::

## ctxloom trust publish forget

Drop the recorded decision for a remote (it is asked about again)
...
```
ctxloom trust publish forget <remote-url> [flags]
```
