...
// filesystem (a zero-value agent.SessionStore{} — NewSessionStore was
// deleted as a redundant "default to the OS fs" mechanism: agent.GetFS
// already defaults a nil Fs to afero.NewOsFs()). Tests override
